                    ...
                    <form className="text-center">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full h-48 px-3 py-2 placeholder-gray-400 text-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
